...
\caption{}
\label{fig:svm_C_const1}
\end{figure}
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{./figs/svm_C_const2.eps}
\caption{}
\label{fig:svm_C_const2}
\end{figure}
%
...
\\
\solution The following code plots Figs. \eqref{fig:svm_C_const1} and \eqref{fig:svm_C_opt2}.\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{./figs/svm_C_opt1.eps}
\caption{}
\label{fig:svm_C_opt1}
\end{figure}
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{./figs/svm_C_opt2.eps}
\caption{}
\label{fig:svm_C_opt2}
\end{figure}
\end{enumerate}
\end{document}
