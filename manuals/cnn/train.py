...
#Pickle file in which parameters should be updated
PICKLE_FILE = 'output3.pickle'
# PICKLE_FILE = 'trained.pickle'


#Train Data extracting
m =500
...
for epoch in range(0,NUM_EPOCHS):
	...
	for batch in batches:
		...
		print("Epoch:"+str(round(per,2))+"% Of "+str(epoch+1)+"/"+str(NUM_EPOCHS))
...
for i in range(0,len(test_data)):
	...
	print('Actual digit: '+str(int(y[i]))+' Predicted digit: '+str(digit)) 
	if digit==y[i]:
		corr+=1
