...
%\author{Alok Ranjan Kesari$^{1}$, K Prasanna Kumar$^{2}$ and G V V Sharma$^{3}$ 
%%<-this  stops a space
%\thanks{1. e-mail:  alok.kesari@yahoo.co.in.,  2. email: kk.prassu924@gmail.com, 3. 
%The 
%author is with the Department
%of Electrical Engineering, Indian Institute of Technology, Hyderabad
%502285 India .  e-mail:  gadepall@iith.ac.in}% <-this % stops a space
%%%\thanks{J. Doe and J. Doe are with Anonymous University.}% <-this % stops a space
%%%\thanks{Manuscript received April 19, 2005; revised January 11, 2007.}}
%}
%\author[1]{Alok Ranjan Kesari\thanks{1 e-mail:  alok.kesari@yahoo.co.in}}
%\author[2]{K Prasanna Kumar\thanks{2 email: kk.prassu924@gmail.com}}
%\author[3]{G V V Sharma \thanks{3 e-mail:  gadepall@iith.ac.in}}
%\affil[3]{Department of Electrical Engineering, Indian Institute of Technology, 
%Hyderabad}
