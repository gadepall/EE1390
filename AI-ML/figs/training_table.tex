...
\hhline{|-|-|-|-|-|-}
	...
	{\gnumericPB{\raggedright}\textbf{Input}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}\textbf{Output / Input file}}
	&\multicolumn{1}{p{\gnumericColD}|}%
	{\gnumericPB{\raggedright}\textbf{Conditioned}}
	&\multicolumn{1}{p{\gnumericColE}|}%
	{\gnumericPB{\raggedright}\textbf{Training}}
	&\multicolumn{1}{p{\gnumericColF}|}%
	{\gnumericPB{\raggedright}\textbf{Testing}}
\\
\hhline{|------|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
